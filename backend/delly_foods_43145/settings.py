"""
Django settings for delly_foods_43145 project.
...
ROOT_URLCONF = 'delly_foods_43145.urls'
...
WSGI_APPLICATION = 'delly_foods_43145.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "delly_foods_43145 API",
    "DESCRIPTION": "API documentation for delly_foods_43145 App",
    "VERSION": "v1",
}
